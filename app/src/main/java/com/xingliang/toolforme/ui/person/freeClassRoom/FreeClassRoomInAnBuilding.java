package com.xingliang.toolforme.ui.person.freeClassRoom;
...
import com.xingliang.toolforme.adapter.person.FreeClassAdapter;
...
public class FreeClassRoomInAnBuilding extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.v("liuyi",seletedBuiding);
        url = String.format(url, URLEncoder.encode(seletedBuiding));
        //Log.v("liuyi",url);
